    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <!--search-->
          <form action="../project/search_s.php" method="POST" class="navbar-form navbar-right" role="search">
...
<div class="w3-row-padding w3-theme" >
<form action="../project/percent_s.php"  method="POST">
...
$result = mysql_query("SELECT * FROM science_clg_db") or die(mysql_error());
