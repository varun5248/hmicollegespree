...
$result = mysql_query("SELECT * FROM engg_clg_db WHERE cutoff<".$abc."") or die(mysql_error());
...
echo "<a href='college_details_e.php?eid=".$id."' style='text-decoration:none;'>";
...
//echo '<script>function myFunction() { <a href="../project/info.html"}</script>';*/
      ...
      echo '<script type="text/javascript">alert("No results found");window.location = "../project/engg_clg.php";</script>';      
    }
}
?>
</div>
