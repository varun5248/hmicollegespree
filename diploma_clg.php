...
<body><style>.dis {pointer-events:none; //This makes it not clickable}.img { position:absolute; z-index: 1; } .img1 { position:absolute;z-index: 2; }</style>
  <!--navbar-->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <!--search-->
          <form action="../project/search_d.php" method="POST" class="navbar-form navbar-right" role="search">
...
<div class="w3-row-padding w3-theme">
<form action="../project/percent_d.php"  method="POST">
...
$result = mysql_query("SELECT * FROM diploma_clg_db") or die(mysql_error());
...
echo "<a href='college_details_d.php?eid=".$id."' style='text-decoration:none;'>";
//echo '<img src="../project/images/6.jpg" class="fishes" style="width:100%;height:200px">'; 
//echo "<img src='".$img."' class='fish' style='width:100%;height:200px'>";
//echo "<img src="../project/images/6.jpg" style="width:100%;height:200px">';
