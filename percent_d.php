...
<body class="w3-row-padding w3-theme"><style>.dis {pointer-events:none; //This makes it not clickable}</style>
  <!--navbar-->
...
$result = mysql_query("SELECT * FROM diploma_clg_db WHERE cutoff<=".$abc."") or die(mysql_error());
...
//echo '<script>function myFunction() { <a href="../project/info.html"}</script>';*/
      ...
      echo '<script type="text/javascript">alert("No results found");window.location = "../project/diploma_clg.php";</script>';      
    }
}
?>
</div>
