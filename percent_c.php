...
$result = mysql_query("SELECT * FROM comm_clg_db WHERE cutoff<".$abc."") or die(mysql_error());
...
//echo '<script>function myFunction() { <a href="../project/info.html"}</script>';*/
      ...
      echo '<script type="text/javascript">alert("No results found");window.location = "../project/comm_clg.php";</script>';      
    }
}
?>
</div>
